...
//! Chauffeur =========================================
  ...
  function editClub(Id_C,Nom,mail,type,image) {

    var input_Id_C = document.getElementById("id_Club");
    input_Id_C.value = Id_C;

    var input_Nom = document.getElementById("nameu");
    input_Nom.value = Nom;
    
    var input_mail = document.getElementById("mailu");
    input_mail.value = mail;
  ...
  function editMat(Id_M,Nom,type,image,nom_club) {

    var input_Id_M = document.getElementById("id_M");
    input_Id_M.value = Id_M;

    var input_Nom = document.getElementById("nameum");
    input_Nom.value = Nom;
    
   

    var input_type = document.getElementById("typeum");
    input_type.value = type;

    var input_image = document.getElementById("imageum");
    input_image.value = image;

    

    var input_nom_club= document.getElementById("nom_clu");
    input_nom_club.value = nom_club;
  ...
  /====================products==================================/
  function editproducts(id,name,description,price,quantity_disp) {

    var input_idp = document.getElementById("id");
    input_idp.value =id;
  
    var input_name = document.getElementById("nameuu");
    input_name.value = name;
    
    var input_description = document.getElementById("descriptionu");
    input_description.value = description;

    var input_price = document.getElementById("priceu");
    input_price.value = price;

    var input_quantity_disp = document.getElementById("quantity_dispu");
    input_quantity_disp.value = quantity_disp;
