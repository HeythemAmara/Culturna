...
$once = isset($_GET['once']) ? $_GET['once'] : 1;
...
$link="https://8b99-197-22-195-150.ngrok-free.app/Culturna/perso/New Front/View/Page_SharedLocalisation.php?id_Client=".$id_Client."&id_chauffeur=".$id_Chauffeur;
...
if($once==0)
{
    try {
       ...
       $mail->Username= 'culturnaskapere@gmail.com';
        ...
        $mail->Subject = "Driver's Location";
        $mail->Body = '
