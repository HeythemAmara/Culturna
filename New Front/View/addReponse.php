   ...
   ) 
{
    ...
    if(isset($_POST['Add'])) {
        ...
        $mail->Password = 'butypmaavmtwkspr';  
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        ...
        $Username1= $ReclamationC->getmail($idRecadd);
        if($Username1=="0")
        {
            $Username1="fersi.hela@esprit.tn";
        }
        $mail->addAddress($Username1);
        $mail->Subject = 'Nouvelle réponse à une réclamation';
        $mail->Body    = 'Sujet de la réponse : '.$SRadd.'<br>Message de la réponse : '.$MRadd.'<br>ID de la réclamation : '.$idRecadd.'<br>ID du client : '.$idClientadd;
