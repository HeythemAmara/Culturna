...
<body>
	...
	<section class="List">
        ...
        ?>
					<tr>
						...
						<td>
							...
							echo "<a href='deleteRerserClient.php?val_id=" . $valeur_id ."&idReserv=".$test."'><i class='edit-del-icon uil uil-trash-alt'></i></a>"; ?>
						</td>
					</tr>
                    <?php
        }
		...
		<form class="form-group" method="POST" action="ModifierReservation.php" onsubmit="return validateFormModifReservUser();">
   	 <ul>
        <li>
