	...
	<div class="burger">
	  ...
	  <!--! Table or list ============================================== -->
		...
		<div class="InputlistAdd slide-in-right">
			...
			<form  class="form-group" method="POST" action="addMat.php">
				...
				<ul>
					...
					<li>
						<input type="text" name="nameam" class="form-style" placeholder="Nom" id="nameam" autocomplete="off">
		...
		<div class="InputlistEdit slide-out-right">
			...
			<form  class="form-group" method="POST" action="updateMat.php">
				...
				<ul>
					...
					<li>
						<input type="number" name="id_M" class="form-style" placeholder="id Materiel a Modifier" id="id_M" autocomplete="off">
						<i class="input-icon uil uil-dialpad-alt"></i>
					</li>
					<li>
						<input type="text" name="nameum" class="form-style" placeholder="Nom" id="nameum" autocomplete="off">
						<i class="input-icon uil uil-clipboard"></i>
					</li>
					<li>
          ...
          <option value="FootBall">FootBall</option>
				...
				<input type="submit" name="Updatem" value="Submit" class="btn mt-4">
			</form>
