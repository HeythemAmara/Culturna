    ...
    <header id="header">
        ...
        <nav class="header-back">
            <ul>
                ...
                <li class="displaylogin "><a href="#"									 >Dashboard</a></li>
					...
					<div class="section pb-5 pt-5 pt-sm-2 text-center"> 
						...
						<div class="card-3d-wrap mx-auto">
							<div class="card-3d-wrapper">
								<form class="card-front" method="POST" action="login.php">
								...
								<!-- HERE ================================================================================================================================= -->
								<form class="card-back" method="POST" action="InscriptionUtilisateur.php">
									<div class="center-wrap">
