...
<head>
  ...
  <link rel="stylesheet" href="../View/Reservation.css">
...
<body>
    ...
    <header id="header">
        ...
        <div class="header-back">
            <ul>
                ...
                <li><?php echo "<a href='Evenement.php?val_id=" . $valeur_id ."&creationreserv=".$test."'>Evenement</a>"; ?></li>
                <li><a href="#">Reclamation</a></li>
				<li><a href="#">Magasin</a></li>
                <li><a href="#"><?php echo "<a href='Reservation.php?val_id=" . $valeur_id ."'>Reserveation</a>"; ?></li>
	...
	<section class="List">
        ...
        ?>
					<tr>
						...
						<td>
							...
							echo "<a href='deleteTransportClient.php?val_id=" . $valeur_id ."&Id_T=".$test."'><i class='edit-del-icon uil uil-trash-alt'></i></a>"; ?>
						</td>
					</tr>
                    <?php
        }
		...
		<div class="InputlistEdit">
			...
			<form  class="form-group" method="POST" action="ModifierTransport.php"  onsubmit="return validateFormModifTransportUser();" >
