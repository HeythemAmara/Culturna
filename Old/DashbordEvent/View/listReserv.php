...
<body>
    ...
    <div> <a href="addReserv.php">Add Reservation</a> </div> <br>
    <table border="2px">
        <tr>
            <th>idReserv</th>
            <th>idEvent</th>
        ...
        <?php
       /* foreach ($r as $row) {
            echo "<tr> <td>" . $row['idReserv'] . "</td> <td>" . $row['idEvent'] . "</td> <td>" . $row['name']  . "</td> <td>" . $row['email'] .
             "</td> <td>" . $row['nbrPlace'] .  "</td> <td>" . $row['num'] .  "</td> <td> <a href='deleteReserv.php?id=" . $row['idReserv'] 
            . "'>Delete</a> </td> <td> <a href='updateReserv.php?id=" . $row['idReserv'] . "'>Update</a> </td> </tr>";
        }*/
        ?>
    </table>
</body>
	...
	<section class="List">
        ...
        ?>
					<tr>
						...
						<td>
							<a href="deleteReserv.php?idEvent=<?php echo $Reservation['idReserv']; ?>"><i class="edit-del-icon uil uil-trash-alt"></i></a>
						</td>
					</tr>
                    <?php
        }
